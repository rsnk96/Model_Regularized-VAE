...
class vae(object):
    ...
    def _create_network_(self):
        ...
        # self.small_X_placeholder = tf.placeholder(tf.float32, [None]+[self.X_size[0]/2-1,self.X_size[1]/2-1,self.X_size[2]])

        self.fc_size = 32*39*51 # Size to flatten to after 2nd convolution 
    ...
    def getGenerator(self):
        ...
        # self.output = tf.nn.sigmoid(trans_conv_1)
