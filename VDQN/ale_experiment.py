...
class ALEExperiment(object):
    def __init__(self, ale, agent, resized_width, resized_height,
                 ...
                 frame_skip, death_ends_episode, max_start_nullops, rng, VAE, sess):
        self.ale = ale
        self.agent = agent
    ...
    def _act(self, action):
        ...
        self.ale.getScreenRGB(self.screen_buffer[index, ...])
    ...
    def get_observation(self):
        ...
        max_image_resized = self.resize_image(max_image)
        obs_encoded = self.VAE.encode_ML(self.sess, np.reshape(max_image_resized, (1,)+max_image_resized.shape))
