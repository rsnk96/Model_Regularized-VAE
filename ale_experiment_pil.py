...
class ALEExperiment(object):
    ...
    def resize_image(self, image):
        ...
        if self.resize_method == 'crop':
            ...
            resized = np.array(Image.fromarray(image).resize((self.resized_width, resize_height),Image.BILINEAR))
            ...
            return np.array(Image.fromarray(image).resize((self.resized_width, resize_height),Image.BILINEAR))
        else:
